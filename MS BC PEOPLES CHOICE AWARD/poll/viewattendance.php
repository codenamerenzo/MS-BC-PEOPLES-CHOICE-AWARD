...
<body>
	...
	<legend><font color = "black"><u>Results:</legend>
		...
		<fieldset class="fs1">
					...
					<span class="total-votes"><?php echo $salado ?></span> Salado
						...
						<img class="avatar" src="Resources/1 Salado FB Editted.jpg"> 
				...
				<li>
					...
					<img class="avatar" src="Resources/2 Vallejos FB Editted.jpg">
				...
				<li>
					...
					<img class="avatar" src="Resources/3 Borbon FB Editted.jpg">
					<br />
				...
				<li>
					...
					<img class="avatar" src="Resources/Rostata FB Editted.jpg">
				...
				<li>
					...
					<img class="avatar" src="Resources/5 Angusan FB Editted.jpg">
					<br />
				...
				<img class="avatar" src="Resources/6 Balbero FB Editted.jpg">
				<br />
	...
	<fieldset class="fs2">
			...
			<li>
				...
				<img class="avatar" src="Resources/7 Enario FB Editted.jpg">
				<br />
			...
			<li>
				...
				<img class="avatar" src="Resources/8 Dilao FB Editted.jpg">
				<br />
			...
			<li>
				...
				<img class="avatar" src="Resources/9 Limen FB Editted.jpg">
				<br />
			...
			<li>
				...
				<img class="avatar" src="Resources/10 Peralta FB Editted.jpg">
				<br />
			...
			<li>
				...
				<img class="avatar" src="Resources/11 Orlanes FB Editted.jpg">
			...
			<li>
				...
				<img class="avatar" src="Resources/12 Espanol FB Editted.jpg">
				<br />
